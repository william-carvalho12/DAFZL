...
?>
    ...
    <section id="intro">
      <div class="intro-content">
        <h2>Bem Vindo ao canal do Aluno!</h2>
        <h3></h3>
        <div>
          ...
          <div class="span12">
            <div class="cta-box">
              <div class="row">
                <div class="span8">
                  <div class="cta-text">
                    <h2>Conheça nosso portal <span>EAD</span> Reforço e Pré Vestibular</h2>
                  </div>
                </div>
                <div class="span4">
                  <div class="cta-btn">
                    <a href="/ead" class="btn btn-color">Acesse <i class="icon-caret-right"></i></a>
                  </div>
                </div>
                  ...
                  <div class="item">
                    <figure>
                      ...
                      <figcaption>
                        <h3>ENGETEC</h3>
                        <p>
                          <a href="img/dummies/works/1.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
                          <a href="http://fateczl.edu.br/engetec/index.html"><i class="icon-file icon-circled icon-bglight icon-2x active"></i></a>
                        </p>
                      </figcaption>
                    </figure>
                  </div>
